function [beta0 omega0 S0 alpha0]=inwprior(ar,arvar,lambda1,lambda2,lambda3,lambda4,lambda5,n,m,p,k,q,prior,bex,blockexo)
...
% compute alpha0 from (1.4.12)
alpha0=n+2;

% finally compute S0, depending on which choice has been made for the prior ((1.4.13) or identity)
if prior==31
