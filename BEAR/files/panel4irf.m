function [irf_record D_record gamma_record struct_irf_record irf_estimates D_estimates gamma_estimates strshocks_record strshocks_estimates]=panel4irf(Yi,Xi,beta_gibbs,sigma_gibbs,It,Bu,IRFperiods,IRFband,N,n,m,p,k,T,IRFt,signrestable,signresperiods)
