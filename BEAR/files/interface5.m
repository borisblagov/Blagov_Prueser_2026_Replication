function [stvol,It,Bu,pick,pickf,bex,ar,lambda1,lambda2,lambda3,lambda4,lambda5,gamma,alpha0,delta0,gamma0,zeta0,interface,interinfo5]=interface5(pref,interinfo5)
...
c22=uicontrol('style','edit','unit','pixels','position',[230 238 50 20],'BackgroundColor',[1 1 1],'FontName','Times New Roman','FontSize',10,'HorizontalAlignment','center','CallBack',@cb22);
...
if validation==2
   ...
   save('userpref5.mat','stvol','It','Bu','pick','pickf','bex','ar','lambda1','lambda2','lambda3','lambda4','lambda5','gamma','alpha0','delta0','gamma0','zeta0')
