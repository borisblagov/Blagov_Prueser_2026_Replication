function [equilibrium,chvar,regimeperiods,Fpconfint,Fpconfint2,regime1,regime2,Dmatrix]=loadmaprior(endo,exo,startdate,pref,data)
...
xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],strngs,'mean-adj prior','B2');
