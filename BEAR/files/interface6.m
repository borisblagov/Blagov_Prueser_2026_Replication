...
% create each radiobutton in the group
c27=uicontrol(c26,'Style','radiobutton','String','None','Position',[0 40 150 18],'FontName','Times New Roman','FontSize',10);
c28=uicontrol(c26,'Style','radiobutton','String','Choleski factorisation','Position',[160 40 150 18],'FontName','Times New Roman','FontSize',10);
c29=uicontrol(c26,'Style','radiobutton','String','Triangular factorisation','Position',[0 5 150 18],'FontName','Times New Roman','FontSize',10);
c30=uicontrol(c26,'Style','radiobutton','String','Sign restrictions','Position',[160 5 150 18],'FontName','Times New Roman','FontSize',10);

% forecast evaluation
c31=uicontrol('style','text','unit','pixels','position',[20 225 150 16],'String','Forecast evaluation:','HorizontalAlignment','left','FontName','Times New Roman','FontSize',10);
...
% disactivate sign restrictions as a possible structural identification scheme
   if IRFt==4
   IRFt=1;
   set(c26,'SelectedObject',c27);
   end
set(c30,'Visible','off');
set(c30,'Enable','inactive');
...
function cb26(hObject,callbackdata)
   ...
   elseif get(c26,'SelectedObject')==c28 || get(c26,'SelectedObject')==c29 || get(c26,'SelectedObject')==c30
