function [tvbvar,It,Bu,pick,pickf,alltirf,gamma,alpha0,delta0,interface,interinfo7]=interface7(pref,interinfo7)
...
if validation==2
   ...
   if pref.pref==1
   save('userpref7.mat','tvbvar','It','Bu','pick','pickf','alltirf','gamma','alpha0','delta0');
