...
% write in excel
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],rescell,'resids','B2');
end
...
% write in excel
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],varcoeffcell,'coeffs time variation','B2');
end
...
if tvbvar==2
   ...
   % write in excel
   if pref.results==1
      xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],varcovcell,'time variation','B2');
   end
