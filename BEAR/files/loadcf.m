...
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],strngs,'cf conditions','B2');
end
...
% if no error is returned, record on Excel
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],strngs,'cf shocks','B2');
end
end
...
% if no error is returned, record on Excel
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],strngs,'cf blocks','B2');
end
end
...
% if no error is returned, record on Excel
if pref.results==1
    xlswrite([pref.datapath '\results\' pref.results_sub '.xlsx'],strngs,'cf intervals','B2');
end
end
