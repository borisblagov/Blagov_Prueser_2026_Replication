function [prior,ar,lambda1,lambda2,lambda3,lambda4,lambda5,lambda6,lambda7,lambda8,It,Bu,hogs,bex,scoeff,iobs,lrp,interface,interinfo2]=interface2(pref,interinfo2)
...
c3=uicontrol(c2,'Style','radiobutton','String','Minnesota (univariate AR)','Position',[7 107 250 18],'FontName','Times New Roman','FontSize',10);
...
c6=uicontrol(c2,'Style','radiobutton','String','Normal-diffuse','Position',[7 32 250 18],'FontName','Times New Roman','FontSize',10);
c7=uicontrol(c2,'Style','radiobutton','String','<html> Dummy observations </html>','Position',[7 7 285 18],'FontName','Times New Roman','FontSize',10);
c8=uicontrol(c2,'Style','radiobutton','String','<html> Normal-Wishart (S<sub>0</sub> as univariate AR) </html>','Position',[280 107 285 18],'FontName','Times New Roman','FontSize',10);
...
c10=uicontrol(c2,'Style','radiobutton','String','<html> Independent Normal-Wishart (S<sub>0</sub> as univariate AR) </html>','Position',[280 57 420 20],'FontName','Times New Roman','FontSize',10);
...
jLabel = javaObjectEDT('javax.swing.JLabel',labelStr);
[hcomponent,hcontainer] = javacomponent(jLabel,[20 301 170 16],gcf);
% create the box
...
jLabel = javaObjectEDT('javax.swing.JLabel',labelStr);
[hcomponent,hcontainer] = javacomponent(jLabel,[20 205 170 16],gcf);
c19=uicontrol('style','edit','unit','pixels','position',[240 203 50 20],'BackgroundColor',[1 1 1],'FontName','Times New Roman','FontSize',10,'HorizontalAlignment','center','CallBack',@cb19);
% default values for lambda4
set(c19,'String',lambda4);
...
if validation==2
   ...
   save('userpref2.mat','prior','ar','lambda1','lambda2','lambda3','lambda4','lambda5','lambda6','lambda7','lambda8','It','Bu','hogs','bex','scoeff','iobs','lrp');
