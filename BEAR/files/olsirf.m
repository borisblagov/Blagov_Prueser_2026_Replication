function [irf_estimates,D,gamma,D_estimates,gamma_estimates]=olsirf(betahat,sigmahat,IRFperiods,IRFt,Y,X,n,m,p,k,q,endo,decimaldates1,stringdates1,pref,IRFband)
...
hold on
strs=plot(decimaldates1,ETA(ii,:),'Color',[0.4 0.4 1],'LineWidth',2);
