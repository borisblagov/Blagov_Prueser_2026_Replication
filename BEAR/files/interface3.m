function [ar,lambda1,lambda2,lambda3,lambda4,lambda5,It,Bu,bex,interface,interinfo3]=interface3(pref,interinfo3)
...
if validation==2
   ...
   save('userpref3.mat','ar', 'lambda1', 'lambda2', 'lambda3', 'lambda4', 'lambda5', 'It', 'Bu', 'bex')
